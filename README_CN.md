...
P3DE 基于 **[Processing 4](https://github.com/processing/processing4)** 构建。我们非常感谢 Processing 基金会及其社区提供如此强大且易于使用的创意编程环境。Processing 4 采用 [GNU LGPL](https://www.gnu.org/licenses/lgpl-3.0.html) 和 [GPL](https://www.gnu.org/licenses/gpl-3.0.html) 协议授权。
